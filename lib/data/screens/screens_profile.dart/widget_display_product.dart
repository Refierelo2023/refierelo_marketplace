...
class WidgetDisplayProduct extends StatefulWidget {
  final String nameProduct;
  final File? imageProduct; 


  const WidgetDisplayProduct({
    required this.nameProduct,
    this.imageProduct,
    super.key, });

  @override
  WidgetDisplayProductState createState() => WidgetDisplayProductState();
}

class WidgetDisplayProductState extends State<WidgetDisplayProduct> {
        ...
        children: [
          Container(
            ...
            width: MediaQuery.of(context).size.width *
                0.12, //  50% del ancho de la pantalla
          ),
          Column(
            children: [
              Row(
