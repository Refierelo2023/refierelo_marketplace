                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(
                          children: [
                            Image.asset('assets/images/mi_actividad/2.png', height: size.height * 0.04,),
                            SizedBox(width: size.width * 0.01),
                            const Text('Mis referidos' , style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
                          ],
                        ),
