...
class ScreensPopupGold extends StatelessWidget {
  const ScreensPopupGold({super.key});
          ...
          child: Column(
            ...
            children: [
              const Align(
                ...
                child: CustomFontAileronBold3grey(text: '\$160.000'),
              ),
              const Align(
                alignment: Alignment.center,
              ...
              Column(
                ...
                children: [
                  ...
                  const Divider(),
                  buildListTile('Qr digital - Qr fisico'),
                  const Divider(),
                  buildListTile('Publicación 20 productos'),
                  const Divider(),
