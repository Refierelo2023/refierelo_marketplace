...
class ViewScreenProduct extends StatefulWidget {
  const ViewScreenProduct({
    super.key,
  });

  @override
  State<ViewScreenProduct> createState() => _ViewScreenProductState();
}

class _ViewScreenProductState extends State<ViewScreenProduct>
